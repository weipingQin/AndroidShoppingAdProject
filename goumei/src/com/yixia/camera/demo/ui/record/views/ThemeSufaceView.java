...
import com.yixia.camera.demo.ui.record.MediaObject;
...
public class ThemeSufaceView extends SurfaceView implements Callback {
	...
	/** 视频存储对象 */
	private com.yixia.camera.model.MediaObject mMediaObject;
	/** 当前主题 */
...
//			}
	...
	/** 设置视频存储信息 */
	public void setMediaObject(com.yixia.camera.model.MediaObject obj) {
