...
import com.www.goumei.BaseApplication;
...
public final class PreferenceUtils {
	...
	public PreferenceUtils() {
		this(BaseApplication.getContext(), PreferenceKeys.PERFERENCE);
	}
	...
	public static String getString(String key, String defValue) {
		if (BaseApplication.getContext() != null) {
			return PreferenceManager.getDefaultSharedPreferences(BaseApplication.getContext()).getString(key, defValue);
		}
		return defValue;
	}
	...
	public static long getLong(String key, long defValue) {
		if (BaseApplication.getContext() != null) {
			return PreferenceManager.getDefaultSharedPreferences(BaseApplication.getContext()).getLong(key, defValue);
		}
		return defValue;
	}
	...
	public static float getFloat(String key, float defValue) {
		if (BaseApplication.getContext() != null) {
			return PreferenceManager.getDefaultSharedPreferences(BaseApplication.getContext()).getFloat(key, defValue);
		}
		return defValue;
	}
	...
	public static int getInt(String key, int defValue) {
		if (BaseApplication.getContext() != null) {
			return PreferenceManager.getDefaultSharedPreferences(BaseApplication.getContext()).getInt(key, defValue);
		}
		return defValue;
	}
	...
	public static void putStringProcess(String key, String value) {
		if (BaseApplication.getContext() != null) {
			SharedPreferences sharedPreferences = BaseApplication.getContext().getSharedPreferences("preference_mu", Context.MODE_MULTI_PROCESS);
			Editor editor = sharedPreferences.edit();
	...
	public static void remove(String... keys) {
		if (keys != null && BaseApplication.getContext() != null) {
