...
public class EditActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null) {
			videoPath = bundle.getString("localVideoPath");
			saveVideoPath = bundle.getString("saveVideoPath");
		}
		initview();
	...
	public void onClick(View arg0) {
		...
		case R.id.cover_text_setcover:
			...
			intent4.setClass(EditActivity.this, ThemeselectActivity.class);
			startActivityForResult(intent4, 004);
			break;
		case R.id.cover_text_theme:
			// 选择主题
			Intent intent1 = new Intent();
			intent1.setClass(EditActivity.this, ThemeActivity.class);
			startActivityForResult(intent1, 001);
			break;
		case R.id.cover_text_cla:
			// 选择分类
			Intent intent2 = new Intent();
			intent2.setClass(EditActivity.this, ThemeclaActivity.class);
			startActivityForResult(intent2, 002);
			break;
		case R.id.cover_text_rel:
			// 添加相关
			Intent intent3 = new Intent();
			intent3.setClass(EditActivity.this, ThemerelActivity.class);
		...
		case R.id.cover_img_play:
			...
			if (videoPath != null) {
				...
				Toast.makeText(EditActivity.this, "文件不存在", Toast.LENGTH_LONG)
						.show();
			}
			break;
		case R.id.qqShare:
	...
	public class DialogHelper extends AsyncTask<Integer, Void, Integer> {
		...
		protected void onPreExecute() {
			ProcessUtil.showProgressDialog(EditActivity.this, "上传数据中...");
		}
		...
		protected void onPostExecute(Integer result) {
			...
			case 200:
				...
				if (updateCode == 200) {
					UIHelper.showMsg(EditActivity.this, "数据上传成功");
					EditActivity.this.finish();
				} else {
					UIHelper.showMsg(EditActivity.this, "数据上传失败");
				}
				break;
