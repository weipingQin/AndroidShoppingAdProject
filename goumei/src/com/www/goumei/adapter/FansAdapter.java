...
public class FansAdapter extends BaseAdapter {
	...
	public FansAdapter(Context context,List<FriendData> list2) {
	...
	public View getView(final int position, View view, ViewGroup rg) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(context).inflate(
					R.layout.layout_fans_item, null);
...
//		}
		if(bean.getBirthday()!=null){
			holder.time.setText(bean.getBirthday());
		}
		...
		if(bean.getIndividualitySignature()!=null){
			holder.signature.setText(bean.getIndividualitySignature());
		}
