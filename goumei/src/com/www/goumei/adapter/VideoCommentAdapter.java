...
import com.www.goumei.emoji.EmoticonsTextView;
...
public class VideoCommentAdapter extends BaseAdapter {
	...
	public VideoCommentAdapter(Context context,List<CommentData> list2) {
	...
	public View getView(final int position, View view, ViewGroup rg) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(context).inflate(
					R.layout.layout_detail_comment_item, null);
			...
			holder.signature=(EmoticonsTextView)view.findViewById(R.id.fansId);
...
//		}
		if(bean.getUserHeadsculpture()!=null){
			imageLoader.displayImage(bean.getUserHeadsculpture(), holder.icon, options);
		}
		
		holder.name.setText(bean.getUserDisplayName());
...
//		}
		...
		holder.reply.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				ToastUtils.showLongToast(context, "回复");
			}
		});
		holder.detail.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				ToastUtils.showLongToast(context, "详情");
			}
		});
	...
	private class viewHolder {
		...
		private EmoticonsTextView signature;
