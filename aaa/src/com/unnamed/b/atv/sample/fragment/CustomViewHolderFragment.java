...
import com.unnamed.b.atv.sample.holder.SocialViewHolder.SocialItem;
import com.unnamed.b.atv.view.AndroidTreeView;

/**
 * Created by Bogdan Melnychuk on 2/12/15.
 */
@SuppressLint("NewApi") public class CustomViewHolderFragment extends Fragment {
        ...
        tView.setDefaultNodeClickListener(new TreeNodeClickListener() {
			...
			public void onClick(TreeNode node, Object value) {
				if(value instanceof IconTreeItem){
					node.addChild(new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.ic_person, "Barry Allen")).setViewHolder(new ProfileHolder(getActivity())));
